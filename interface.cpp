...
Interface::Interface(string name){
    ...
    m_name = name;
    //m_functions["list"] = &Optionable::list;
    //m_functions["json_list"] = &Optionable::list;
...
//void Interface::parseAction(Options & options){
//    
//    string action = options.next();
//    
//    if(action == "list")
//        list();
//    else if(action == "json_list")
//        json_list();
//    else if(action == "add")
//        /*add(options)*/;
//    
//
//    else if(m_nic_list.find(action) != m_nic_list.end()){
//        
//        m_interface = action;
//        
//        parseAction(options);
//    } else {
//        cout << "error: " << action << " interface not exists" << endl;
//    }
//}
